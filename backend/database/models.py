...
class Bill(Base):
    ...
    Attributes:
        ...
        pley_id (str): ID for the Proyecto de Ley (legally used by the parliament)
        bill_diff (bool): True if the bill has at least one bill_differences
            row with difference_type in {"first_version", "no_change",

...
| Column | Type | Key | Description |
|---|---|---|---|
| bill_id | String | PK | Bill identifier (e.g., "2021_3") |
...
| summary_congreso | String | | Summary generated by OpenCongress |
...
| vote_event_id | String | FK → vote_events.id | Id of the vote.
...
| Column | Type | Key | Description |
|---|---|---|---|
| motion_id | String | PK, FK → motions.motion_id | A unique identifier for the motion. |
...
| org_id | String | PK, FK → organizations.org_id | The identifier of the organization.
